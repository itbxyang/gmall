...
import com.atguigu.gmall.message.utils.SmsUtils;
...
public class SmsListener {
    ...
    @RabbitListener(bindings = @QueueBinding(
            value = @Queue(value = "GMALL-SMS-QUEUE", durable = "true"),
            exchange = @Exchange(value = "GMALL-SMSCODE-EXCHANGE", ignoreDeclarationExceptions = "true", type = ExchangeTypes.TOPIC),
            key = {"verifycode.sms"}
    ))
